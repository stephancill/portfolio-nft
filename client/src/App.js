          ...
          >
            ...
            {walletConnected ? <>  
              {wrongNetwork ? <>
                ...
                <PortfolioSetup trackedAssets={trackedAssets} walletConnected={walletConnected} cont={contracts} walletAddress={walletAddress} signer={signer} tokenList={tokenList}/>
              </>}
            </> : <>
