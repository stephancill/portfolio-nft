...
contract BalanceWatcherNFT is ERC721 {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        for (uint256 i = 0; i < 5; i++) {
            ...
            // TODO: Display total value

            // TODO: Use https://github.com/mzhu25/sol2string
            // TODO: Commify numbers
            parts[0] = abi.encodePacked('<text x="26" y="', Strings.toString(80+45*i), '" class="base item">', tokenContract.symbol(), '</text>');
            parts[1] = abi.encodePacked('<text x="145" y="', Strings.toString(80+45*i), '" class="base item">$', Strings.toString(value), '</text>');
            parts[2] = abi.encodePacked('<text x="26" y="', Strings.toString(95+45*i), '" class="base sub">', Strings.toString(balance), '</text>');
